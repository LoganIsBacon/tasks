...
export function isCorrect(question: Question, answer: string): boolean {
    ...
    const lowerCaseExpected = question.expected.toLowerCase();
    //Used chatGPT to help me use the .expected property on question.

    const trimAnswer = lowerCaseAnswer.trim();
    const trimExpected = lowerCaseExpected.trim();
...
export function toMarkdown(question: Question): string {
    let exampleFormat = "# " + question.name + "\n" + question.body;
    if (question.type === "multiple_choice_question") {
        exampleFormat =
            "# " +
            question.name +
...
export function mergeQuestion(
    ...
    const newQuestion = {
        ...
        points,
        published: false,
        includes: contentQuestion.includes,
        toLowerCase: contentQuestion.toLowerCase,
